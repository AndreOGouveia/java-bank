...
public class    Messages {
    ...
    public final static String MENU_TRANSFER = "Transfer Between Accounts";
    ...
    public final static String CHOOSE_ACCOUNT_ORIGIN = "Please insert origin account number: ";
    public final static String CHOOSE_ACCOUNT_DESTINATION = "Please insert destination account number: ";
