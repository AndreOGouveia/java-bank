...
public class AccountTransactionView extends AbstractView {
    ...
    public void show() {
        ...
        if (transactionController.getCustomerService().getLoginCustomer().getAccountIds().size() == 0) {
            showNoAccounts();
            return;
        }
    ...
    private int scanAccount() {
        ...
        Customer customer = transactionController.getCustomerService().getLoginCustomer();
